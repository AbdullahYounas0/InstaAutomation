          ...
          <form onSubmit={handleSubmit} className="script-form">
            ...
            <div className="form-group">
              ...
              <input
                ...
                disabled={isRunning}
              />
              <small>File containing target users to DM (username, bio, city, etc.)</small>
            </div>
            ...
            <div className="form-group checkbox-group">
              ...
              <small>Display browser windows in a grid to watch the DM automation in real-time</small>
            </div>
