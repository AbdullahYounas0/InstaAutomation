...
describe('ToastManager', () => {
  ...
  it('displays correct toast content', async () => {
    ...
    if (React.isValidElement(toastContent)) {
      ...
      expect(container).toHaveTextContent('CAPTCHA/2FA verification required');
      expect(container).toHaveTextContent('Please manually solve the verification');
      expect(container).toHaveTextContent('Auto-resuming in 5 minutes...');
